...
fun Triangle.calculateABAngle(): Int {
    ...
    val scalarMultiplication = previousCameraVector.x * currentCameraVector.x + previousCameraVector.y * previousCameraVector.y + previousCameraVector.z * currentCameraVector.z

    val currentVector = sqrt(currentCameraVector.x.pow(2) + previousCameraVector.y.pow(2) + currentCameraVector.z.pow(2))
